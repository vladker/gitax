"""
Журнал отправленных Cargo (Rust) пакетов.

Хранится в cargo_journal.json.
...
class CargoJournal(RuntimeJournalMixin, BaseJournal):
    """Журнал отправленных Cargo пакетов"""
